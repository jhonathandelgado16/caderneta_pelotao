<div class="row justify-content-md-center">
    ...
    <div class="row">
        <form class="col-12 row" action="<?= URL_RAIZ . 'avaliacoes/pesquisar' ?>" method='post'>
    ...
    <table class="table">
        ...
        <?php foreach ($militares as $militar) : ?>
            <tr>
                ...
                <td>
                    <a href="<?= URL_RAIZ . 'avaliacoes/' . $militar->getId() . '/criar' ?>" class="btn btn-xs btn-edit" title="Aplicar Punição">
                        <img class="icone" src="<?= URL_PUBLICO . '/img/avaliacao.png'  ?>" alt="">
                    </a>
                </td>
            </tr>
        <?php endforeach ?>
