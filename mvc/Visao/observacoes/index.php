<div class="row justify-content-md-center">
    <div class="col-8">
    <h2 class="">Observações da <?= $usuario->getSu()->getNome() ?></h1>
    <div class="row">
        <nav class="col-6">
            <a href="<?= URL_RAIZ . 'observacoes/primeira_pesquisa' ?>" class="btn btn-success">Cadastrar Nova Observação</a>
        </nav>
    </div>
    <div class="row">
